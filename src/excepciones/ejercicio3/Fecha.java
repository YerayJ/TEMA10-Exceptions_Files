...
public class Fecha {
     ...
     */
    public void setDia(int dia) throws ErrorDayException {
        if (dia >= 1 && dia <= 31) {
            this.dia = dia;
        } else {
     ...
     */
    public void setMes(int mes) throws ErrorMonthException{
        if (mes >= 1 && mes <= 12) {
            this.mes = mes;
        } else {
     ...
     */
    public void setAnho(int anho) throws ErrorYearException{
        if (anho < 1962) {
